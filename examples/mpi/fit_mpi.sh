...
time ./oral_2cmt_mpi sample num_samples=20 num_warmup=150 save_warmup=0 algorithm=hmc stepsize=0.01 adapt delta=0.8 id=$CHAIN  data file=mpi_test_serial.R init=mpi_init.R random seed=12 output refresh=1 file=samples-$CHAIN-serial.csv
